 ...
 */
abstract contract Bytes32BareComponent is IComponent, OwnableWritable {
    error Bytes32BareComponent__NotImplemented();
     ...
     */
    mapping(uint256 => bytes32) internal entityToValue;
     ...
     */
    function set(uint256 entity, bytes memory value)
        public
        override
        onlyWriter
    {
     ...
     */
    function getRawValue(uint256 entity)
        public
        view
        virtual
        override
        returns (bytes memory)
    {
        ...
        return abi.encodePacked(entityToValue[entity]);
    }

    /**
     * Not implemented in Bytes32BareComponent
     */
    ...
    {
        revert Bytes32BareComponent__NotImplemented();
    }

    /**
     * Not implemented in Bytes32BareComponent
     */
    function getEntitiesWithValue(bytes memory)
        public
        view
        virtual
        override
